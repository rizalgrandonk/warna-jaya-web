...
const Navbar = () => {
  ...
  const inActiveClass = "absolute z-20 w-[80vw] top-14 left-1/2 -translate-x-1/2  shadow-[-10px_10px_0_0_grey]"
  ...
  return (
    <>
    <header className={ `hidden md:block bg-white transition-all ${activeNav ? activeClass : inActiveClass}` }>
          ...
          <div className="flex items-center px-4 gap-8 h-12">
            <ul className="h-full flex items-stretch gap-8 uppercase text-sm font-medium px-4">
              ...
              <li className="relative group flex justify-center items-center gap-1 cursor-pointer">
                <p className="hover:text-primary transition-all">Product</p><span><FaAngleDown/></span>
                ...
                <ul className="absolute top-12 left-0 bg-white py-3 text-black drop-shadow-2xl w-48 transition-all opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto">
                  <li className="py-3 flex items-center">
                    <Link href={"/"}>
                      <a className="hover:text-primary transition-all px-3">Product</a>
                    </Link>
                  </li>
                  <li className="py-3 flex items-center">
                    <Link href={"/"}>
            ...
            <div className="flex items-center gap-2 group">
              ...
              <div>
                ...
                <p className="uppercase text-primary font-bold text-sm">+62 821 3125 6256</p>
              </div>
            </div>
          </div>
        </nav>
      ...
      <div className="container mx-auto">
        ...
        <nav className={`absolute transition-all bg-white w-full z-0 ${togleMenu ? 'left-0' : 'left-[30rem]'}`}>
          <ul className="uppercase text-sm font-medium p-4">
            ...
            <li className="py-3">
              <p onClick={() => setTogleDropDown(!togleDropDown)} className="hover:text-primary transition-all cursor-pointer flex items-center gap-1">Product <span><FaAngleDown/></span></p>

              <ul className={`uppercase text-sm font-medium p-2 pb-0 ${togleDropDown ? 'block' : 'hidden'}`}>
                <li className="py-3">
                  <Link href={"/"}>
