...
const Footer = () => {
  return (
    <footer className="w-full bg-gray-300 px-2">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-start gap-8 py-10 px-2 border-b border-gray-200">
        <div className="w-full md:w-[40%]">
          ...
          <p className="px-1 mt-4 text-sm leading-relaxed">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Excepturi quae earum similique officia inventore corrupti in ad architecto, neque quos veritatis, velit reprehenderit cupiditate fugit eius corporis iure officiis eum.</p>
        </div>

        <div className="w-full md:w-[30%]">
          <h3 className="text-2xl font-semibold py-1">Navigation</h3>
          <span className="block h-0.5 w-full bg-gray-200 relative mb-4">
        ...
        <div className="w-full md:w-[30%] text-sm">
          ...
          <p className="py-2"><span className="font-bold">Address : </span>Jl. Jalan</p>
          <p className="py-2"><span className="font-bold">Email : </span>warnajayasby150@gmail.com</p>
          <p className="py-2"><span className="font-bold">Phone : </span>(031)3521675</p>
          <p className="py-2"><span className="font-bold">WhatsApp : </span>082131256256</p>
        </div>
      </div>
